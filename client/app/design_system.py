...
QTableWidget::item { padding: 0 16px; border-bottom: 1px solid #E2E8F0; }
QHeaderView::section {
    background: #FFFFFF;
    border: 0;
    border-bottom: 1px solid #E2E8F0;
...
QPushButton#START_NEW_SCREENING { min-height: 62px; max-height: 62px; }
...
def apply_design_system(root: QWidget) -> None:
    ...
    for button in root.findChildren(QPushButton):
        ...
        minimum = 48
        if button.objectName() == "START_NEW_SCREENING":
            minimum = 64
