...
Every family maps 1:1 to a README §5 spec — no invented primitives.
...
- `components/{forms,feedback,flow,data}/` — primitives + `.d.ts` + `.prompt.md` + card HTML.
